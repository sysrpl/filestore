...
public static class BuildInfo
{
    ...
    public static string ProductName =>
        App.GetCustomAttribute<AssemblyProductAttribute>()?.Product ?? "S3 File Explorer";
    ...
    public static IReadOnlyList<(string Name, string Value)> Details()
    {
        ...
        [
            ...
            ("AWS SDK for S3", InformationalVersion(typeof(AmazonS3Client).Assembly)),
        ];
    }

    /// <summary>The BuildDate stamped in by filestore.csproj, in local time.</summary>
